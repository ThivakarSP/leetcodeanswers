...
**Runtime**: `6 ms` (Beats 45.80%)

**Memory**: `126.6 MB` (Beats 71.37%)
...
**Notes**:
Uses prefix maximum and suffix minimum arrays to check each index in linear time, returning the first index where the difference is within k.
