...
**Notes**:
The solution checks overlap by comparing the coordinates of the two rectangles using constant-time arithmetic operations, resulting in constant time and space usage.
