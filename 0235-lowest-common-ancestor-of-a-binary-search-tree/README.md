...
**Runtime**: `6 ms` (Beats 96.84%)

**Memory**: `47.7 MB` (Beats 35.10%)
...
**Notes**:
Recursively traverses the BST, moving left or right based on value comparisons, yielding logarithmic time and space on average.
