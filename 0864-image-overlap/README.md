...
**Runtime**: `60 ms` (Beats 51.14%)

**Memory**: `44.5 MB` (Beats 75.76%)
...
**Notes**:
The algorithm exhaustively tries all possible shifts of img2 relative to img1 and counts overlapping 1s, resulting in a fourth‑order time complexity and constant extra space.
