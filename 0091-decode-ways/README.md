...
**Runtime**: `1 ms` (Beats 81.51%)

**Memory**: `43.2 MB` (Beats 33.95%)
...
**Notes**:
The solution uses a DP array where dp\[i\] represents the number of ways to decode the first i characters, updating based on single and double digit possibilities.
