...
**Notes**:
The solution counts each number’s frequency across all length‑k subarrays using a hash map, then selects the largest number that appears in exactly one subarray.
