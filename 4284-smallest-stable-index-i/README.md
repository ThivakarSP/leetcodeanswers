...
**Notes**:
The algorithm uses nested loops over the array to compute max and min for each index, resulting in quadratic time and constant extra space.
