...
**Notes**:
The algorithm iterates over ranges of powers of 1000, adding the appropriate comma counts, resulting in logarithmic time and constant space.
