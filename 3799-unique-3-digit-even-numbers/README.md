...
**Runtime**: `6 ms` (Beats 50.40%)

**Memory**: `45.7 MB` (Beats 78.27%)
...
**Notes**:
Iterates over all permutations of three distinct digits, filters by non-zero hundreds and even units, and uses a hash set to deduplicate results.
