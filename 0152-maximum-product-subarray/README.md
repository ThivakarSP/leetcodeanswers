...
**Notes**:
The algorithm iterates once through the array, maintaining current maximum and minimum products to handle negative numbers, achieving linear time and constant extra space.
