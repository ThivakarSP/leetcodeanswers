...
**Runtime**: `83 ms` (Beats 9.55%)

**Memory**: `47.6 MB` (Beats 53.99%)
...
**Notes**:
Uses a hash map to track character counts while expanding and contracting a window to maintain uniqueness.
